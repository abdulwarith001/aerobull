/**
 *Submitted for verification at basescan.org on 2024-04-12
*/
...
contract ARB is ERC20, Ownable {
    ...
    constructor() ERC20("AeroBull", "ARB") {
        ...
        marketingWallet = address(0x620871Fb6E6921951baCFa0B7c13A9319b405117);
        devWallet = address(0x620871Fb6E6921951baCFa0B7c13A9319b405117);
    ...
    function updateFees(uint8 _marketingFeeBuy, uint8 _liquidityFeeBuy,uint8 _devFeeBuy,uint8 _marketingFeeSell, uint8 _liquidityFeeSell,uint8 _devFeeSell) external onlyOwner{
        ...
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevFee;
        require(_fees.buyTotalFees <= 8, "Must keep fees at 30% or less");   
        require(_fees.sellTotalFees <= 8, "Must keep fees at 30% or less");
